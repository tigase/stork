...
public class AccountAdvancedPreferencesActivity extends Activity {
	...
	private final boolean isMobileAvailable(JaxmppCore jaxmpp) {
	...
	public void onCreate(Bundle icicle) {
		...
		boolean available = isMobileAvailable(getMulti().get(accountJid));
		mobileOptimizations.setEnabled(available);
		presenceQueueTimeout.setEnabled(available);
