...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (!TextUtils.isEmpty(mPassword)) mPasswordEdit.setText(mPassword);
        if (!TextUtils.isEmpty(mNickname)) mNicknameEdit.setText(mNickname);
        if (!TextUtils.isEmpty(mHostname)) mHostnameEdit.setText(mHostname);
